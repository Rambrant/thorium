//
// hal::keysight_l4411a::L4411A's own tests, moved here verbatim from framework/hal/tests/
...
namespace
{
    static_assert(   std::constructible_from< hal::keysight_l4411a::L4411A, hal::InstrumentId, hal::Lan> );
    static_assert(   std::constructible_from< hal::keysight_l4411a::L4411A, hal::InstrumentId, hal::Usb> );
    static_assert(   std::constructible_from< hal::keysight_l4411a::L4411A, hal::InstrumentId, hal::Simulated> );
    static_assert( ! std::constructible_from< hal::keysight_l4411a::L4411A, hal::InstrumentId, hal::Gpib> );
    static_assert( ! std::constructible_from< hal::keysight_l4411a::L4411A, hal::InstrumentId, hal::Serial> );
...
TEST( HalInstrument, TwoL4411AsAreDistinguishableByInstrumentId)
{
    ...
    {
        hal::keysight_l4411a::L4411A first{ ids[ 0], hal::Simulated{} };
        hal::keysight_l4411a::L4411A second{ ids[ 1], hal::Simulated{} };
...
// hal::keysight_n6701a::N6701A's mainframe slot was carried for a while before anything read
...
{
    hal::keysight_l4411a::L4411A dmm1{ hal::InstrumentId::Dmm1, hal::Lan( "bench-dmm1") };

# hal::keysight_dso8064a::DSO8064A

Agilent/Keysight Infiniium **DSO8064A** — four channels, 600 MHz. Header-only,
`namespace hal`, included as `"hal/keysight_dso8064a.hpp"`.
...
slope. Same convention as `core::MeasureSetup` and `hal::racal1260::Rs232Config`.
...
thirty specific things went wrong. `hal::keysight_dso8064a::MeasurementFault` carries the subset
...
away. Same shape as `hal::keysight_l4411a::L4411A`'s mode edge. See `tests/test_keysight_dso8064a.cpp`.

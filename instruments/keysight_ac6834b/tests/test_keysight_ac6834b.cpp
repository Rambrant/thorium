...
namespace
{
    static_assert(   std::constructible_from< hal::keysight_ac6834b::Ac6834B, hal::InstrumentId, hal::Gpib> );
    static_assert(   std::constructible_from< hal::keysight_ac6834b::Ac6834B, hal::InstrumentId, hal::Serial> );
    static_assert(   std::constructible_from< hal::keysight_ac6834b::Ac6834B, hal::InstrumentId, hal::Simulated> );
    static_assert( ! std::constructible_from< hal::keysight_ac6834b::Ac6834B, hal::InstrumentId, hal::Lan> );
    static_assert( ! std::constructible_from< hal::keysight_ac6834b::Ac6834B, hal::InstrumentId, hal::Usb> );
    static_assert( ! std::constructible_from< hal::keysight_ac6834b::Ac6834B, hal::InstrumentId> );
} // namespace
...
// ---------------------------------------------------------------------------
// The unbalanced half of hal::keysight_ac6834b::AcBuilder -- see hal::keysight_ac6834b::Balanced/hal::keysight_ac6834b::PerPhase
...
TEST_F( SourceInstrumentFixture, AcPerPhaseVoltagesReachTheirOwnPhases)
{
    ...
    EXPECT_DOUBLE_EQ( acP1.phaseVoltage( hal::keysight_ac6834b::Phase::A).value(), 115.0);
    EXPECT_DOUBLE_EQ( acP1.phaseVoltage( hal::keysight_ac6834b::Phase::B).value(), 113.0);
    EXPECT_DOUBLE_EQ( acP1.phaseVoltage( hal::keysight_ac6834b::Phase::C).value(), 117.0);
}
...
TEST_F( SourceInstrumentFixture, AcAPerPhaseSetterSwitchesTheConfigToPerPhase)
{
    ...
    const auto perPhase = acP1.ac().phaseVoltage( hal::keysight_ac6834b::phaseA( 115.0_V), hal::keysight_ac6834b::phaseB( 113.0_V), hal::keysight_ac6834b::phaseC( 117.0_V));

    static_assert( std::is_same_v<decltype( balanced)::Config, hal::keysight_ac6834b::AcConfig<hal::keysight_ac6834b::Balanced>>);
    static_assert( std::is_same_v<decltype( perPhase)::Config, hal::keysight_ac6834b::AcConfig<hal::keysight_ac6834b::PerPhase>>);
}
...
TEST_F( SourceInstrumentFixture, AcAScalarSetterAfterTheSplitBroadcastsRatherThanReverting)
{
    ...
    // Still per-phase: the transition is one-way (see hal::keysight_ac6834b::AcBuilder).
    static_assert( std::is_same_v<decltype( builder)::Config, hal::keysight_ac6834b::AcConfig<hal::keysight_ac6834b::PerPhase>>);
...
TEST_F( SourceInstrumentFixture, AcPerPhaseCurrentLimitsReachTheirOwnPhases)
{
    apply( acP1.ac()
                ...
                .currentLimit( hal::keysight_ac6834b::phaseA( 3.0_A), hal::keysight_ac6834b::phaseB( 2.0_A), hal::keysight_ac6834b::phaseC( 4.0_A)));

    // The voltage was set before the split and broadcasts to all three.
    EXPECT_DOUBLE_EQ( acP1.phaseVoltage( hal::keysight_ac6834b::Phase::B).value(), 115.0);

    EXPECT_DOUBLE_EQ( acP1.currentLimit( hal::keysight_ac6834b::Phase::A)->value(), 3.0);
    EXPECT_DOUBLE_EQ( acP1.currentLimit( hal::keysight_ac6834b::Phase::B)->value(), 2.0);
    EXPECT_DOUBLE_EQ( acP1.currentLimit( hal::keysight_ac6834b::Phase::C)->value(), 4.0);
}
...
// overload to call (see hal::keysight_ac6834b::AcConfig's own comment). Stated as a
...
namespace
{
    ...
    {
        builder.frequency( hal::keysight_ac6834b::phaseA( v), hal::keysight_ac6834b::phaseB( v), hal::keysight_ac6834b::phaseC( v));
    };

    template<typename BuilderT, typename ValueT>
    concept HasPerPhaseVoltage = requires( BuilderT builder, ValueT v)
    {
        builder.phaseVoltage( hal::keysight_ac6834b::phaseA( v), hal::keysight_ac6834b::phaseB( v), hal::keysight_ac6834b::phaseC( v));
    };
} // namespace

TEST_F( SourceInstrumentFixture, AcFrequencyHasNoPerPhaseForm)
{
    using BuilderT = hal::keysight_ac6834b::AcBuilder<hal::keysight_ac6834b::Balanced>;
    ...
    static_assert( ! HasPerPhaseFrequency<BuilderT, Frequency>,
                   ...
                   "share a frequency by construction (see hal::keysight_ac6834b::AcConfig)");
}
...
// hal::keysight_ac6834b::PhaseValue).
//
namespace
{
    template<typename BuilderT, typename ValueT>
    ...
    {
        builder.phaseVoltage( hal::keysight_ac6834b::phaseB( v), hal::keysight_ac6834b::phaseA( v), hal::keysight_ac6834b::phaseC( v));
    };
} // namespace

TEST_F( SourceInstrumentFixture, AcPhasesCannotBeGivenOutOfOrder)
{
    static_assert( ! AcceptsTransposedPhases<hal::keysight_ac6834b::AcBuilder<hal::keysight_ac6834b::Balanced>, Voltage>,
...
{
    apply( acP1.ac().phaseVoltage( hal::keysight_ac6834b::phaseA( 115.0_V), hal::keysight_ac6834b::phaseB( 113.0_V), hal::keysight_ac6834b::phaseC( 117.0_V)));

    EXPECT_EQ( acP1.measuredVoltage( hal::keysight_ac6834b::Phase::A).qualifier(), "A");
    EXPECT_EQ( acP1.measuredVoltage( hal::keysight_ac6834b::Phase::C).qualifier(), "C");

    EXPECT_DOUBLE_EQ( acP1.measuredVoltage( hal::keysight_ac6834b::Phase::A).rawMeasure().value(), 115.0);
    EXPECT_DOUBLE_EQ( acP1.measuredVoltage( hal::keysight_ac6834b::Phase::B).rawMeasure().value(), 113.0);
    EXPECT_DOUBLE_EQ( acP1.measuredVoltage( hal::keysight_ac6834b::Phase::C).rawMeasure().value(), 117.0);
}
...
// hal::keysight_ac6834b::to_string( Phase)). Asserted because the failure mode of getting this
...
{
    EXPECT_EQ( hal::keysight_ac6834b::to_string( hal::keysight_ac6834b::Phase::A), "A");
    EXPECT_EQ( hal::keysight_ac6834b::to_string( hal::keysight_ac6834b::Phase::B), "B");
    EXPECT_EQ( hal::keysight_ac6834b::to_string( hal::keysight_ac6834b::Phase::C), "C");

    // And the list used by every per-phase loop is the same three, in order.
    static_assert( hal::keysight_ac6834b::phases.size() == 3);
    EXPECT_EQ( hal::keysight_ac6834b::phases[ 1], hal::keysight_ac6834b::Phase::B);
}
...
// hal::keysight_ac6834b::Ac6834B::measuredFrequency and its neighbours.
//
...
TEST_F( SourceInstrumentFixture, AcNeutralCurrentIsItsOwnReadingNotAFourthPhase)
{
    ...
    EXPECT_DOUBLE_EQ( acP1.measuredCurrent( hal::keysight_ac6834b::Phase::B).rawMeasure().value(), 2.0);
    EXPECT_DOUBLE_EQ( acP1.measuredNeutralCurrent().rawMeasure().value(),        0.4);
}
...
TEST_F( SourceInstrumentFixture, AcHasNoUnqualifiedVoltageReading)
{
    ...
    static_assert( HasUnqualifiedFrequency<hal::keysight_ac6834b::Ac6834B>);

    static_assert( ! HasUnqualifiedVoltage<hal::keysight_ac6834b::Ac6834B>,
...
TEST_F( SourceInstrumentFixture, AcRangeResolvesToWhatTheInstrumentWouldSelect)
{
    ...
    // not stored verbatim.
    static_assert( hal::keysight_ac6834b::rangeFor( 115.0_V) == hal::keysight_ac6834b::LowVoltageRange);
    static_assert( hal::keysight_ac6834b::rangeFor( 150.0_V) == hal::keysight_ac6834b::LowVoltageRange);   // boundary: 150 is not "greater than 150"
    static_assert( hal::keysight_ac6834b::rangeFor( 150.1_V) == hal::keysight_ac6834b::HighVoltageRange);
    static_assert( hal::keysight_ac6834b::rangeFor( 230.0_V) == hal::keysight_ac6834b::HighVoltageRange);
...
{
    apply( acP1.ac()
                .phaseVoltage( hal::keysight_ac6834b::phaseA( 115.0_V), hal::keysight_ac6834b::phaseB( 230.0_V), hal::keysight_ac6834b::phaseC( 115.0_V))
                .range(        hal::keysight_ac6834b::phaseA( 115.0_V), hal::keysight_ac6834b::phaseB( 230.0_V), hal::keysight_ac6834b::phaseC( 115.0_V)));

    EXPECT_DOUBLE_EQ( acP1.range( hal::keysight_ac6834b::Phase::A)->value(), 150.0);
    EXPECT_DOUBLE_EQ( acP1.range( hal::keysight_ac6834b::Phase::B)->value(), 300.0);
    EXPECT_DOUBLE_EQ( acP1.range( hal::keysight_ac6834b::Phase::C)->value(), 150.0);
}
...
TEST_F( SourceInstrumentFixture, AcAnApplyThatSaysNothingAboutTheRangeLeavesItAlone)
{
    ...
    ASSERT_DOUBLE_EQ( acP1.range( hal::keysight_ac6834b::Phase::A)->value(), 300.0);

    apply( acP1.ac().phaseVoltage( 115.0_V));

    EXPECT_DOUBLE_EQ( acP1.range( hal::keysight_ac6834b::Phase::A)->value(), 300.0);
}
...
TEST_F( SourceInstrumentFixture, AcRangeIsUnsetUntilSomethingSetsIt)
{
    ...
    EXPECT_FALSE( acP1.range( hal::keysight_ac6834b::Phase::A).has_value());
}

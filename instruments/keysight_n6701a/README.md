...
hal::keysight_n6701a::Direct dcP2{ hal::InstrumentId::DcP2, hal::Gpib( 0, 14), 2 };
```
...
overload that compiles at all. That's `hal::keysight_n6701a::SwitchableIsolation` doing the work.
...
asserted directly in `tests/test_keysight_n6701a.cpp` using a tag the driver has never
heard of.

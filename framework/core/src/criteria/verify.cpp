...
{
    //
    // Posts to the run journal (core/journal/journal.hpp) rather than printing. This
    // used to write a line straight to stdout, which meant
    ...
    // event to the terminal (see core/journal/console_sink.hpp), so what an operator

...
namespace core
{
    namespace
    {
        ...
        // symbol genuinely is the empty string (see core/quantities/quantity.hpp).
        //
        [[nodiscard]]
        ...
        // are. See core/session/stimulus.hpp on why one value is not a one-element list.
        //
    ...
    auto unitSymbol( const QuantityKind kind) -> std::string_view
    {
        ...
        // (see core/quantities/quantity.hpp), and anything else here would be a second

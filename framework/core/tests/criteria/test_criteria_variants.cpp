...
{
    //
    // The selection is process-wide (see core/criteria/criteria_variants.hpp on why it
...
TEST_F( CriteriaVariants, EveryKnownVariantIsCompiledIn)
{
    ...
    // core/criteria/detail/no_criteria_variants.inc), so this is the assertion that

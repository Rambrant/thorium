...
// sends and what Read hands back (see core/verbs/transfer.hpp). These tests are about
...
//
// The bound on the rendering -- see kMaxDescribedBody in core/quantities/bytes.hpp. A

...
//
// The whole reason core/criteria/predicate_text.hpp exists: a reader has to be able to
...
// core/criteria/predicate_text.hpp) leaves the required column empty rather than
...
// description slot instead (see core/criteria/verify.hpp), so this is back to guarding

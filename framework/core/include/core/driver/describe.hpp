...
// hal/keysight_edu36311a.hpp, hal/keysight_ac6834b.hpp and hal/racal1260.hpp for the bodies, and
...
namespace core
{
    ...
    // only ever reads Instrument -- see hal/keysight_edu36311a.hpp), so only Apply and Setup

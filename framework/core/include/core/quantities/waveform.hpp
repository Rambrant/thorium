...
namespace core
{
    ...
    // is a stated limit a test specification carries (see core/criteria/criterion.hpp);
    ...
    // core/quantities/bytes.hpp) -- there is no length at which spelling out four thousand

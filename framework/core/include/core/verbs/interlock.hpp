...
namespace core
{
    ...
    // of magnitude; nothing is destroyed today. core/verbs/source.hpp has said for
    ...
    // core/driver/describe.hpp), which makes a deliberate hot switch a thing the log
    ...
    // through (see core/verbs/measure.hpp). This is the framework declining to ask,
    ...
    namespace detail
    {
        ...
        // connectDriver (see core/verbs/source.hpp and core/verbs/route.hpp), and found

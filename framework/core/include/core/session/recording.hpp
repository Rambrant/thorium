...
namespace core
{
    ...
    // core::ISession::fetchData in core/session/session.hpp).
    //
    ...
    // completed within its timeout (see core::AwaitEngine in core/verbs/acquire.hpp).
    ...
    // core/verbs/trace.hpp) -- an observation like the other three, and one a replay
    ...
    // identifier may contain, and so no unit added to core/quantities/quantity_kind.hpp in

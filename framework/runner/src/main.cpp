...
// modes, matching what tools/run-tests.sh and framework/ui/ expect:
//
...
//                                  is (see cli.hpp and framework/ui/README.md)
...
namespace
{
    ...
    struct Options
    {
        ...
        // optionsModel and framework/ui/README.md). The model is generated from the same
    ...
    struct RunLogs
    {
        ...
        // framework/ui/README.md), where there is no file to hold.
        //

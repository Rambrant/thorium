...
namespace launcher
{
    ...
    // mistake (see framework/ui/README.md Sec.4). Routing it through the tray
    // icon as well as an in-page button is what keeps that promise once the
    // console is a browser window that can simply be closed.
    //

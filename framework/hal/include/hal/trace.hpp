...
// Await (see hal/acquire.hpp): the record is already inside the instrument by
...
//
// Defined in hal/measure.cpp rather than in a translation unit of its own, and
...
// to rely on. See hal/measure.hpp, which says this about Read at more length.
//

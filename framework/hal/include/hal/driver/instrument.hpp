...
namespace hal
{
    ...
    // Dmm2 might both be hal::keysight_edu34450a::EDU34450A -- see hal/keysight_edu34450a.hpp) and be
    ...
    // hal::keysight_edu36311a::EDU36311A's own class name (not this enum) tied to the physical
    // instrument model -- see hal::keysight_edu36311a::EDU36311A's own comment in hal/keysight_edu36311a.hpp.
    //
...
#pragma pop_macro( "INSTRUMENTS")
    ...
    //
    // Empty marker base -- every concrete instrument driver (hal::keysight_edu34450a::EDU34450A,
    // hal::keysight_dsox1202g::DSOX1202G, hal::keysight_edu36311a::EDU36311A<Isolation>, hal::keysight_ac6834b::Ac6834B) inherits it
    ...
    // instruments that don't satisfy it: see hal::keysight_edu34450a::EDU34450A::safe() for why

...
// Setup and Write (see hal/source.hpp): arming a capture and asking whether it
...
//
// Both are defined in hal/measure.cpp, not in a translation unit of their own,
...
// is no initialisation order to rely on. See hal/measure.hpp, which says this
// about Read at more length.
//
// Arm needs no bank and could have lived beside Apply and Setup in
// hal/source.cpp. It is here instead because the pair is one operation split in

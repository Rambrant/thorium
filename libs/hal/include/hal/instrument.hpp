...
namespace hal
{
    ...
    // core::meta::all()/get() in core/criterion.hpp, hal::isWired() in
    // hal/wiring.hpp, the criteria-variant parity check in
    ...
    // remaining instance of a solved problem. hal/src/safing.cpp used to
...
#pragma pop_macro( "INSTRUMENTS")
    ...
    // hal::DSO8064, hal::N6701A<Isolation>, hal::Ac6834B) inherits it
    // publicly, and nothing else does. hal::safeRig() (hal/src/safing.cpp)

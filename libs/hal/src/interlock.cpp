...
// visible outside a translation unit that expands them -- see hal/measure.cpp
// and hal/route.cpp, which are the same shape for the same reason.
//
...
namespace hal
{
    ...
    {
        //
        // In an unnamed namespace, unlike hal/src/safing.cpp's identical pair
    ...
    // declares the instrument globals; see hal/src/safing.cpp's own comment on

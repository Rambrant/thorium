//
// hal::L4411A's tests used to live here too, and now live with the driver, in
// instruments/l4411a/tests/test_l4411a.cpp. The DSO8064 half below goes the
// same way when that driver moves; what stays here for good is the part about
// hal's own generic mechanism -- hal::InstrumentId and to_string() over it,
// which exist without reference to any particular instrument.
//

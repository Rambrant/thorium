...
public:
    ...
    [[nodiscard]] virtual IOscilloscope* oscilloscope() = 0;
    [[nodiscard]] virtual IVoltmeter* voltmeter() = 0;
    [[nodiscard]] virtual IPowerSupply* power_supply() = 0;

    // The switch matrix in the signal chain.
    [[nodiscard]] virtual ISwitchMatrix& matrix() = 0;
};

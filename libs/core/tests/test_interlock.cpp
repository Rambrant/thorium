...
namespace mock
{
    ...
    //
    // Deliberately not shared with libs/core/tests/test_bench.cpp's mock of the
...
namespace
{
    ...
    class InterlockTest : public ::testing::Test
    {
        protected:
            ...
            {
                // The bench is process-wide (see core/bench.hpp), so a test
...
// still pass while the *build* broke somewhere in core/route.hpp instead.
//
